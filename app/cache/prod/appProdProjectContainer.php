...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/assetic/config'), false)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'stampsymfony', 'host' => '192.96.219.129', 'port' => 3306, 'user' => 'stamp', 'password' => '512955208', 'driver' => 'pdo_mysql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/jms_diextra/doctrine/EntityManager_516227995a5b1.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_71e583062aed11eeba2d161a9855830f');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_71e583062aed11eeba2d161a9855830f');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_71e583062aed11eeba2d161a9855830f');
        ...
        $f->setProxyDir('/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager516227995a5b1_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($g, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/logs/prod.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $c->setKernel($b);
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/profiler', '', '', 86400), $a);
        $instance->disable();
        $instance->add($c);
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/sessions');
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => '/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/../web', false);
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => '/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod',
            ...
            'session.save_path' => '/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/sessions',
            ...
            'profiler.storage.dsn' => 'file:/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/profiler',
            ...
            'router.resource' => '/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => '/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(
            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/jms_diextra/doctrine/EntityManager_516227995a5b1.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager516227995a5b1_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/var/lib/stickshift/516128664382ec80f8000693/app-root/data/459869/s/app/cache/prod/jms_security',
